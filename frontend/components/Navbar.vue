...
<template>
  <header class="flex items-center px-5">
    ...
    <ul class="flex items-center">
      ...
      <li>
        <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="#projects">Project</a>
      </li>
      <li>
        <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="#features">Features</a>
      </li>
      <li>
        <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="#testimonials">Success Stories</a>
      </li>
    </ul>
