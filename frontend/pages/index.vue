<template>
  <div class="landing-page">
    <section class="landing-hero pt-5 px-5">
    ...
    <section class="container mx-auto pt-24 px-5" id="features">
    ...
    <section class="container mx-auto pt-24 px-5" id="projects">
    ...
    <section class="container mx-auto pt-24 px-5" id="testimonials">
      <div class="flex justify-between items-center">
        <div class="w-auto">
          <h2 class="text-3xl text-gray-900 mb-8">
            See What Our <br />
