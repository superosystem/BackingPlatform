...
func (h *campaignHandler) New(c *gin.Context) {
	...
	input := model.FormCreateCampaignRequest{}
	input.Users = users
...
func (h *campaignHandler) Create(c *gin.Context) {
	var input model.FormCreateCampaignRequest
	...
	createCampaignInput := model.CreateCampaignRequest{}
...
func (h *campaignHandler) CreateImage(c *gin.Context) {
	...
	existingCampaign, err := h.campaignService.GetCampaignByID(model.GetCampaignDetailRequest{ID: id})
	if err != nil {
		c.HTML(http.StatusInternalServerError, "error.html", nil)
		return
	}
	...
	createCampaignImageInput := model.CreateCampaignImageRequest{}
...
func (h *campaignHandler) Edit(c *gin.Context) {
	...
	input := model.FormUpdateCampaignRequest{}
...
func (h *campaignHandler) Update(c *gin.Context) {
	...
	var input model.FormUpdateCampaignRequest
	...
	updateInput := model.CreateCampaignRequest{}
	...
	_, err = h.campaignService.UpdateCampaign(model.GetCampaignDetailRequest{ID: id}, updateInput)
	if err != nil {
		c.HTML(http.StatusInternalServerError, "error.html", nil)
		return
	}
