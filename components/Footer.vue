<template>
  <footer class="bg-purple-progress py-20 px-5 text-white text-lg">
      ...
      <div class="sm:flex mb-4">
        ...
        <div class="sm:w-1/4 h-auto">
          ...
          <ul class="font-light">
            ...
            <li class="mb-3">CWG, Kuningan</li>
            <li class="mb-3">No.49 (Backing Platform)</li>
            <li class="mb-3">support@backing-platform.com</li>
          </ul>
        </div>
      </div>
    </div>
